...
/// \todo Add device configuration, USB notifications, surface/device lost
/// handling,
...
class CATVMR9AllocPres : public IVMRSurfaceAllocator9, IVMRImagePresenter9 {
 public:
  ...
  virtual CATResult Init(HWND wnd, CATInt32 w, CATInt32 h, CATCaptureCB cb,
                         void* context);
  ...
  virtual HRESULT STDMETHODCALLTYPE GetSurface(DWORD_PTR dwUserID,
                                               DWORD SurfaceIndex,
                                               DWORD SurfaceFlags,
                                               IDirect3DSurface9** lplpSurface);
  virtual HRESULT STDMETHODCALLTYPE
  AdviseNotify(IVMRSurfaceAllocatorNotify9* lpIVMRSurfAllocNotify);
  ...
  virtual HRESULT STDMETHODCALLTYPE
  PresentImage(DWORD_PTR dwUserID, VMR9PresentationInfo* lpPresInfo);
